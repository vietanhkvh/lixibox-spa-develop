...
Feature: Authenticated Session Render
  On an authenticated session, page renders on a given browser without any error

  Scenario Outline: Page renders without error
    Given user is logged in
    When user browses "<page>"
    Then private session renders the page without error

    Examples:
      | page                                                             |
      | /category                                                        |
      | /category/new-skin-care                                          |
      | /lingerie                                                        |
      | /shop                                                            |
      | /shop/clean-it-zero                                              |
      # Auth pages
      ...
      | /loves/new                                                       |
      # Referral
      # | /invite                                                          | # fails when redirects to /user/invite
      | /invite/nonexistent                                              |
      # Expert
      | /ex                                                              |
      | /ex/reviews                                                      |
