...
import LandingLustreProductModal from '..';
...
const component = (params = {}) => {
  ...
  return withRouter((routerProps) => <LandingLustreProductModal {...Object.assign({}, props, routerProps, params)} />);
};

describe('LandingLustreProductModal', () => {
  test(`renders`, () => {
    expect(() => {
