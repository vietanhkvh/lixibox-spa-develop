...
import MagazineImageSliderItem from '..';
...
const component = (params = {}) => {
  const props = {
    data: magazineRelatedBlogList[0],
    type: 'video',
    column: 5
  };

  return <MagazineImageSliderItem {...Object.assign({}, props, params)} />;
};

describe('MagazineImageSliderItem', () => {
  test(`renders`, () => {
    expect(() => {
