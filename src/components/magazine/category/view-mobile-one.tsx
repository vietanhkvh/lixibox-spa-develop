    ...
    0 !== list.length && (
      <div>
        <div style={STYLE.magazineCategory.boxContent}>
          ...
          >
            {/* main content */}
            <div style={STYLE.magazineCategory.boxContent.largeItem.itemInfo.infoTitle}>{mainItem.title}</div>
            <div
              style={STYLE.magazineCategory.boxContent.largeItem.itemImage(
                decodeEntities(mainItem.cover_image.original_url)
              )}
            ></div>
            <div style={STYLE.magazineCategory.boxContent.largeItem.itemInfo.infoDescription}>
