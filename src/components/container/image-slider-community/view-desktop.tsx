...
const renderSlider = ({ column, handleOmitImgHeight, imageSlideSelected }) => {
  return (
    <div className={'community-image-slider'} style={STYLE.desktop.mainWrap}>
...
const renderNavigation = ({ imageSlide, navLeftSlide, navRightSlide }) => {
  const leftNavProps = {
    ...
    style: Object.assign({}, STYLE.imageSlide.navigation, { top: '50%', transform: 'translateY(-50%)' })
  };
...
export const renderDesktop = ({ props, state, handleMouseHover, selectSlide, navLeftSlide, navRightSlide }) => {
  ...
  return (
    <div {...containerProps} className={'image-slide-container'}>
      {renderSlider({ column, handleOmitImgHeight, imageSlideSelected })}
