...
import ProductDiscountCodeDetailmodal from '../component';
...
const component = (params = {}) => {
  const props = {
    data: {
      discountCode: suggestionDiscountCodes[0]
    },
    addDiscountCodeAction: jest.fn(),
    closeModal: jest.fn()
  };

  return <ProductDiscountCodeDetailmodal {...Object.assign({}, props, params)} />;
};

describe('ProductDiscountCodeDetailmodal', () => {
  test(`renders`, () => {
    expect(() => {
