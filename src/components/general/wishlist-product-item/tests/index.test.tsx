...
const component = (params = {}) => {
  const props = {
    ...
    likeStore: INITIAL_STATE_LIKE,
    productCountOnPage: 10,
    addItemToCartAction: jest.fn(),
    unLikeProductAction: jest.fn(),
    fetchListLikedBoxesAction: jest.fn(),
    openModalAction: jest.fn(),
    openAlertAction: jest.fn()
  };

  return withRouter((routerProps) => <WishlistProductItem {...Object.assign({}, props, routerProps, params)} />);
};

describe('WishlistProductItem', () => {
  test(`renders`, () => {
    expect(() => {
