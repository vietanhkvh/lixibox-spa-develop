...
describe('Breadcrumb', () => {
  ...
  test(`renders subs item`, () => {
    reduxRender(component(), { initialState: {} });
    const e = screen.getByText('cửa hàng');
    expect(e).toBeInTheDocument();
  });

  test(`renders hover popup sub item `, async () => {
    reduxRender(component(), { initialState: {} });
    const itemBreadCrumb = document.getElementsByClassName('item')[0];
    await user.hover(itemBreadCrumb);
    const popup = document.getElementsByClassName('sub flexwrap show')[0];
