...
const component = (params = {}) => {
  const props = {
    ...
    action: { title: 'Add to cart', icon: 'lixibox', disabled: false },
    product: cartList[0].box,
    purchaseType: cartList[0].purchase_type,
    isShowRating: true,
    isShowPricing: true,
    singleItemOnly: true,
    loading: false,
    customPricing: { price: 200000, originalPrice: 210000 },
    tag: 'test-tag',
  ...
  return withRouter((routerProps) => <ItemWithAction {...Object.assign({}, props, routerProps, params)} />);
};

describe('ItemWithAction', () => {
  test(`renders`, () => {
    expect(() => {
