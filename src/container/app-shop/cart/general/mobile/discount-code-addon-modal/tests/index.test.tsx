...
const component = (params = {}) => {
  const props = {
    cartStore: Object.assign({}, INITIAL_STATE_CART, {
      ...
      isDiscountCodeAddonModalOpen: true
    }),
    toggleDiscountCodeAddonModalVisibilityAction: jest.fn()
  };

  return withRouter((routerProps) => <DiscountCodeAddonModal {...Object.assign({}, props, routerProps, params)} />);
};

describe('DiscountCodeAddonModal', () => {
  test(`renders`, () => {
    expect(() => {
