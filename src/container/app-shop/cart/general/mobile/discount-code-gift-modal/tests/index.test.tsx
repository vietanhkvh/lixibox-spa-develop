...
const component = (params = {}) => {
  const props = {
    cartStore: Object.assign({}, INITIAL_STATE_CART, {
      ...
      isDiscountCodeGiftModalOpen: true
    }),
    selectGiftAction: jest.fn(),
    toggleDiscountCodeGiftModalVisibilityAction: jest.fn()
  };

  return withRouter((routerProps) => <DiscountCodeGiftModal {...Object.assign({}, props, routerProps, params)} />);
};

describe('DiscountCodeGiftModal', () => {
  test(`renders`, () => {
    expect(() => {
