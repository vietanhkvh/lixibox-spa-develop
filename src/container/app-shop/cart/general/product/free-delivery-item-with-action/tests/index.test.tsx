...
import FreeDeliveryItemWithAction from '../component';
...
const component = (params = {}) => {
  ...
  return withRouter((routerProps) => <FreeDeliveryItemWithAction {...Object.assign({}, props, routerProps, params)} />);
};

describe('FreeDeliveryItemWithAction', () => {
  test(`renders`, () => {
    expect(() => {
