...
const component = (params = {}) => {
  const props = {
    ...
    resetCheckoutPaymentPhaseReadiness: jest.fn(),
    checkout: jest.fn(),
    fetchUserAddressListAction: jest.fn(),
    selectPaymentMethodAction: jest.fn(),
    openModalAction: jest.fn(),
    deliveryChooseAddress: jest.fn(),
    deliverySetDeliveryMethod: jest.fn(),
    deliveryGuestAddressAction: jest.fn(),
    checkSameDayShippingAction: jest.fn(),
    saveAddressSelected: jest.fn(),
    fetchStoresAction: jest.fn(),
    checkoutAddressAction: jest.fn()
  };

  return withRouter((routerProps) => <Payment {...Object.assign({}, props, routerProps, params)} />);
};
