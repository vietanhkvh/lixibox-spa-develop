...
const component = (params = {}) => {
  const props = {
    cartStore: Object.assign({}, INITIAL_STATE_CART, {
      cartDetail: Object.assign({}, cartDetail, { accompanies })
    }),
    isOpen: true,
    onSubmit: jest.fn(),
    onRequestClose: jest.fn(),
    updateAccompanyServices: jest.fn(),
    fetchAccompanyServices: jest.fn(),
    setAccompaniesLocalAction: jest.fn(),
    touchAccompaniesLocalAction: jest.fn(),
    selectAccompaniesLocalOptionAction: jest.fn(),
    updateAccompaniesLocalNoteAction: jest.fn(),
    toggleSelectedAccompaniesLocalAction: jest.fn()
  };

  return withRouter((routerProps) => <AddonsModal {...Object.assign({}, props, routerProps, params)} />);
};
