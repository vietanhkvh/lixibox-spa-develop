...
const component = (params = {}) => {
  const props = {
    ...
    userStore: Object.assign({}, INITIAL_STATE_USER, {
      userProfile: { list: userProfile }
    }),
    fetchRecentInvoiceAction: jest.fn(),
    fetchCartInvoiceAction: jest.fn(),
    updateInvoiceAction: jest.fn(),
    deleteInvoiceAction: jest.fn()
  };

  return withRouter((routerProps) => <InvoiceBlock {...Object.assign({}, props, routerProps, params)} />);
};
