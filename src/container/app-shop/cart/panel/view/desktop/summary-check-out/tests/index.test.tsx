...
import SummaryCheckout from '../container';
...
const suggestionDiscountCodes = [
    ...
    gift_boxes: [
      {
        ...
        is_individual: true,
        is_saleable: true,
        name: 'Sáp tẩy trang dễ nhũ hoá, làm sạch sâu Okame Super Fruit Cleansing Balm - 7ml',
        original_price: 70000,
        price: 59000,
        primary_picture: {
          facebook_url:
            'https://s3-ap-southeast-1.amazonaws.com/lixibox-staging-uploads/system/pictures/files/000/053/299/facebook/1602414743.jpg?t=1630414386',
          large_url:
            'https://s3-ap-southeast-1.amazonaws.com/lixibox-staging-uploads/system/pictures/files/000/053/299/large/1602414743.jpg?t=1630414386',
          medium_url:
            'https://s3-ap-southeast-1.amazonaws.com/lixibox-staging-uploads/system/pictures/files/000/053/299/medium/1602414743.jpg?t=1630414386',
          original_url:
            'https://s3-ap-southeast-1.amazonaws.com/lixibox-staging-uploads/system/pictures/files/000/053/299/original/1602414743.jpg?t=1630414386',
          square_url:
            'https://s3-ap-southeast-1.amazonaws.com/lixibox-staging-uploads/system/pictures/files/000/053/299/square/1602414743.jpg?t=1630414386',
          thumb_url:
            'https://s3-ap-southeast-1.amazonaws.com/lixibox-staging-uploads/system/pictures/files/000/053/299/thumb/1602414743.jpg?t=1630414386',
          vertical_url:
            'https://s3-ap-southeast-1.amazonaws.com/lixibox-staging-uploads/system/pictures/files/000/053/299/vertical/1602414743.jpg?t=1630414386'
        },
  ...
  },
  {
    ...
    amount: 0,
    code: 'RAINDROP',
    description: 'Tặng bông mút trang điểm Duo Rain Drop cho đơn hàng từ 900K',
    errors: ['Mã chỉ áp dụng cho các đơn hàng trên 900,000 đ'],
    gift_boxes: [
      {
        id: 3510,
        brand_name: 'The Duo Rain Drop',
        is_individual: true,
        is_saleable: true,
        ...
        primary_picture: {
          facebook_url:
            'https://s3-ap-southeast-1.amazonaws.com/lixibox-staging-uploads/system/pictures/files/000/014/524/facebook/1500356498.png?t=1628760890',
          large_url:
            'https://s3-ap-southeast-1.amazonaws.com/lixibox-staging-uploads/system/pictures/files/000/014/524/large/1500356498.png?t=1628760890',
          medium_url:
            'https://s3-ap-southeast-1.amazonaws.com/lixibox-staging-uploads/system/pictures/files/000/014/524/medium/1500356498.png?t=1628760890',
          original_url:
            'https://s3-ap-southeast-1.amazonaws.com/lixibox-staging-uploads/system/pictures/files/000/014/524/original/1500356498.png?t=1628760890',
          square_url:
            'https://s3-ap-southeast-1.amazonaws.com/lixibox-staging-uploads/system/pictures/files/000/014/524/square/1500356498.png?t=1628760890',
          thumb_url:
            'https://s3-ap-southeast-1.amazonaws.com/lixibox-staging-uploads/system/pictures/files/000/014/524/thumb/1500356498.png?t=1628760890',
          vertical_url:
            'https://s3-ap-southeast-1.amazonaws.com/lixibox-staging-uploads/system/pictures/files/000/014/524/vertical/1500356498.png?t=1628760890'
        },
        short_description: 'Description 2',
        slug: 'the-duo-rain-drop',
        status: 'approved'
      }
    ],
    order_price_max: null,
    order_price_min: 900000,
...
const component = (params = {}) => {
  ...
  return withRouter((routerProps) => <SummaryCheckout {...Object.assign({}, props, routerProps, params)} />);
};

describe('SummaryCheckout', () => {
  describe(`when 'pathname' is ${ROUTING_CHECK_OUT}`, () => {
    test(`renders`, () => {
      expect(() => {
        reduxRender(component({ pathname: ROUTING_CHECK_OUT }), { initialState: {} });
      }).not.toThrow();
    });
  });

  describe(`when 'pathname' is ${ROUTING_CHECK_OUT_PAYMENT}`, () => {
    test(`renders`, () => {
      expect(() => {
        reduxRender(component({ pathname: ROUTING_CHECK_OUT_PAYMENT }), { initialState: {} });
      }).not.toThrow();
    });
  });
});
