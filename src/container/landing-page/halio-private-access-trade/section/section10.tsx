...
const Section10 = ({ productData, onAddToCart, isAddCartLoading }) => {
  ...
  const [selectedUrl, setSelectUrl] = useState(5);
  ...
  return (
    <div id="SECTION948" className="ladi-section">
      ...
      <div className="ladi-container">
        ...
        >
          <div className="ladi-gallery ladi-gallery-bottom">
            <div className="ladi-gallery-view">
              <div className={`ladi-gallery-view-item ${0 === selected && 'selected'}`} data-index="0"></div>
        ...
        <div id="SHAPE961" className="ladi-element">
        ...
        <div id="GROUP998" className="ladi-element">
          <div className="ladi-group">
            <div id="BOX957" className="ladi-element">
              <div className="ladi-box"></div>
            </div>
            <div id="HEADLINE996" className="ladi-element">
              <h3 className="ladi-headline">
                <span style={{ color: 'rgb(232, 48, 140)', fontWeight: 'bold' }}>- Công nghệ Sonic Wave Cleansing</span>
                <br />- Đầu gai silicone siêu mảnh 0.6mm
                <br />- Tự động ngắt sau 2 phút
                <br />- Hộp treo nam châm tiện lợi
                <br />- 3 chế độ rung
                <br />- Chống nước IPX7
        ...
        <div id="HEADLINE1168" className="ladi-element">
          <h3 className="ladi-headline">
            Máy rửa mặt Halio Sensitive
            <br />
          </h3>
        </div>
        <div id="GROUP953" className="ladi-element">
          <div className="ladi-group">
            <div id="BOX954" className="ladi-element">
              <div className="ladi-box"></div>
            </div>
            <div id="HEADLINE955" className="ladi-element">
              <h3 className="ladi-headline">
                <span style={{ fontWeight: 'bold', color: 'rgb(232, 48, 140)' }}>Máy rửa mặt Halio Sensitive</span> sở
                hữu thiết kế đặc biệt cùng các tính năng cải tiến nổi bật, giúp làm sạch đến 99.5% dầu thừa, bụi bẩn,
                cặn trang điểm mà vẫn nhẹ nhàng, an toàn với cả những làn da nhạy cảm nhất.
              </h3>
            </div>
          </div>
        </div>
        <div id="GROUP1169" className="ladi-element">
          <div className="ladi-group">
            <div id="SHAPE1170" className="ladi-element">
              <div className="ladi-shape">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="100%"
            ...
            <div id="HEADLINE1171" className="ladi-element">
              <h3 className="ladi-headline">{currenyFormat(originalPrice)}</h3>
            </div>
            <div id="HEADLINE1172" className="ladi-element">
              <h3 className="ladi-headline">{currenyFormat(price)}</h3>
            </div>
          </div>
        </div>
        <div id="HEADLINE1296" className="ladi-element">
          <h3 className="ladi-headline">
            Dành riêng cho da nhạy cảm
            <br />
          </h3>
        </div>
        <div id="GROUP1330" className="ladi-element">
          <div className="ladi-group" id="BUTTON959OUTER">
            <div data-action="true" id="BUTTON959" className="ladi-element">
              <div className="ladi-button">
                <div className="ladi-button-background"></div>
                <div id="BUTTON_TEXT959" className="ladi-element" onClick={handleAddToCart}>
            ...
            <div id="SHAPE1329" className="ladi-element">
              <div className="ladi-shape">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="100%"
        ...
        <div id="GROUP1332" className="ladi-element">
          <div className="ladi-group">
            <div id="BOX1333" className="ladi-element">
              <div className="ladi-box"></div>
            </div>
            <div id="HEADLINE1334" className="ladi-element">
              <h3 className="ladi-headline">
                FREE quà 275K gồm: 1 sữa rửa mặt The Auragins, 1 kem dưỡng ẩm Okame Bakuchiol - Nhập mã{' '}
                <span style={{ fontWeight: 'bold' }}>HSGIFT</span>
              </h3>
            </div>
          </div>
        </div>
