...
const Section5 = ({ productData, onAddToCart, isAddCartLoading }) => {
  ...
  const [selectedUrl, setSelectUrl] = useState(0);
  const handleAddToCart = () => {
    if (isLoading) return;

    const slug = PRODUCT_LIST[selectedUrl];
    setLoading(true);
  ...
  return (
    <div id="SECTION911" className="ladi-section">
      ...
      <div className="ladi-container">
        <div
          ...
          data-max-item="7"
          data-runtime-id="nvsIWVRmDocj"
          data-current="1"
          data-is-next="false"
          data-scrolled="true"
          data-loaded="true"
          data-next-time="1623902167861"
        >
          <div className="ladi-gallery ladi-gallery-bottom">
            <div className="ladi-gallery-view">
              ...
              <div className={`ladi-gallery-view-item ${6 === selected && 'selected'}`} data-index="6"></div>
              <div className={`ladi-gallery-view-item ${5 === selected && 'selected'}`} data-index="5"></div>
            ...
            <div className="ladi-gallery-control">
              <div className="ladi-gallery-control-box" style={{ left: 0 }}>
                ...
                ></div>
                <div
                  className={`ladi-gallery-control-item ${6 === selected && 'selected'}`}
                  onClick={() => {
                    setSelect(6);
                    setSelectUrl(2);
                  }}
                ...
                ></div>
                <div
                  className={`ladi-gallery-control-item ${5 === selected && 'selected'}`}
                  onClick={() => {
                    setSelect(5);
                    setSelectUrl(3);
                  }}
        ...
        <div id="SHAPE932" className="ladi-element">
        ...
        <div id="HEADLINE983" className="ladi-element">
          <h3 className="ladi-headline">
            Máy rửa mặt bán chạy nhất Việt Nam
            <br />
          </h3>
        </div>
        <div id="GROUP915" className="ladi-element">
          <div className="ladi-group">
            <div id="BOX913" className="ladi-element">
              <div className="ladi-box"></div>
            </div>
            <div id="HEADLINE914" className="ladi-element">
              <h3 className="ladi-headline">
                <span style={{ fontWeight: 'bold', color: 'rgb(232, 48, 140)' }}>Máy rửa mặt Halio</span> với khả năng
                làm sạch sâu gấp 10 lần, loại bỏ 99% dầu thừa, bụi bẩn, cặn trang điểm trên da mà vẫn dịu nhẹ, đồng thời
                massage giúp da thư giãn sau một ngày làm việc căng thẳng
              </h3>
            </div>
          </div>
        </div>
        <div id="GROUP916" className="ladi-element">
          <div className="ladi-group">
            <div id="BOX917" className="ladi-element">
              <div className="ladi-box"></div>
            </div>
            <div id="HEADLINE918" className="ladi-element">
              <h3 className="ladi-headline">
                <span style={{ fontWeight: 700 }}>
                  <span style={{ color: 'rgb(232, 48, 140)' }}>- Công nghệ Sonic Wave Cleansing</span>
                  <br />
                </span>
                - Bề mặt cọ làm từ Silicone kháng khuẩn
                <br />- 14 chế độ rung phù hợp cho mọi nhu cầu sử dụng
                <br />- Sử dụng đến 4 tháng chỉ với 1 lần sạc đầy
        ...
        <div id="GROUP1139" className="ladi-element ladi-animation">
          <div className="ladi-group">
            <div id="SHAPE1138" className="ladi-element">
              <div className="ladi-shape">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="100%"
            ...
            <div id="HEADLINE1136" className="ladi-element">
              <h3 className="ladi-headline">{currenyFormat(originalPrice)}</h3>
            </div>
            <div id="HEADLINE1137" className="ladi-element">
              <h3 className="ladi-headline">{currenyFormat(price)}</h3>
            </div>
          </div>
        </div>
        <div id="HEADLINE1293" className="ladi-element">
          <h3 className="ladi-headline">
            Máy Rửa Mặt Halio
            <br />
          </h3>
        </div>
        <div id="GROUP1331" className="ladi-element">
          <div className="ladi-group">
            <div id="BOX1320" className="ladi-element">
              <div className="ladi-box"></div>
            </div>
            <div id="HEADLINE1321" className="ladi-element">
              <h3 className="ladi-headline">
                FREE quà 150K gồm: 5 mặt nạ dưỡng da Lixibox - Nhập mã{' '}
                <span style={{ fontWeight: 'bold' }}>HOGIFT</span>
              </h3>
            </div>
          </div>
        </div>
        <div id="GROUP1328" className="ladi-element ladi-animation">
          <div className="ladi-group">
            <div data-action="true" id="BUTTON929" className="ladi-element">
              <div className="ladi-button">
                <div className="ladi-button-background"></div>
                <div id="BUTTON_TEXT929" className="ladi-element" onClick={handleAddToCart}>
            ...
            <div id="SHAPE1327" className="ladi-element">
              <div className="ladi-shape">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="100%"
