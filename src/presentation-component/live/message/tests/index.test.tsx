...
const component = (params = {}) => {
  const props = {
    ...
    liveRepliesCommentList: replies,
    isFetchLiveCommentList: false,
    receiveNewComment: 1,
    receiveNewRelyComment: 1,
    userInfo,
  ...
  return <LiveMessage {...Object.assign({}, props, params)} />;
};
