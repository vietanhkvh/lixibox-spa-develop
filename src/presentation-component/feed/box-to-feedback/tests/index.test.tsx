...
const productBoxes = [
  {
    ...
    is_saleable: true,
    like_count: 18,
    name: 'Phiếu quà tặng Lixibox Gift Voucher 100k',
    ...
    price_sale_off: 0,
    primary_picture: {
      facebook_url: 'https://upload.lixibox.com/system/pictures/files/000/012/266/facebook/1484019700.jpg?t=1623826443',
      large_url: 'https://upload.lixibox.com/system/pictures/files/000/012/266/large/1484019700.jpg?t=1623826443',
      medium_url: 'https://upload.lixibox.com/system/pictures/files/000/012/266/medium/1484019700.jpg?t=1623826443',
      original_url: 'https://upload.lixibox.com/system/pictures/files/000/012/266/original/1484019700.jpg?t=1623826443',
      square_url: 'https://upload.lixibox.com/system/pictures/files/000/012/266/square/1484019700.jpg?t=1623826443',
      thumb_url: 'https://upload.lixibox.com/system/pictures/files/000/012/266/thumb/1484019700.jpg?t=1623826443',
      vertical_url: 'https://upload.lixibox.com/system/pictures/files/000/012/266/vertical/1484019700.jpg?t=1623826443'
    },
    rating: {
      avg_rate: 5,
      count: 8
    ...
    short_description:
      'Lixibox Gift Voucher - Thời hạn sử dụng: 6 tháng kể từ ngày mua. - Mỗi đơn hàng chỉ có thể dùng một voucher hoặc mã giảm giá. - Chỉ áp dụng khi mua đơn hàng online.',
    slug: 'lixibox-gift-voucher-100000d',
    stock: 6,
    store_stock: 0,
    variant_options: []
  },
...
const component = (params = {}) => {
  ...
  return <BoxToFeedback {...Object.assign({}, props, params)} />;
};

describe('BoxToFeedback', () => {
  test(`renders`, () => {
    expect(() => {
